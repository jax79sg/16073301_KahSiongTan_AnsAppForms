...
# python3 /home/kah1/remote_cookie_runtime/src/pipes/featurePhase2.py '/u01/bigdata/02d_d2vModel1/log_BowVectorSpaceModel.log' '/u01/bigdata/03a_01b_test/cvd2v/032/train' '/u01/bigdata/02d_d2vModel1/cvBowVectorSpaceModel_10000.model' '1' '-1' '10000'
...
if __name__ == "__main__":
    if(len(sys.argv)==8):
        ...
        bow=BOW(utilObj=util, maxDim=maxDim, ngram=ngram)
        ...
        bow2 = BOW(utilObj=util, maxDim=maxDim)
