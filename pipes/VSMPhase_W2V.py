...
# python3 /home/kah1/remote_cookie_runtime/src/pipes/featurePhase4_W2V.py '/u01/bigdata/02d_d2vModel1/log_cvW2v100VectorSpaceModel.log' '/u01/bigdata/03a_01b_test/cvd2v/032/train' '/u01/bigdata/02d_d2vModel1/cvW2v100VectorSpaceModel.model' '1' '10000000' '100'
# python3 /home/kah1/remote_cookie_runtime/src/pipes/featurePhase4_W2V.py '/u01/bigdata/02d_d2vModel1/log_cvW2v300VectorSpaceModel.log' '/u01/bigdata/03a_01b_test/cvd2v/032/train' '/u01/bigdata/02d_d2vModel1/cvW2v300VectorSpaceModel.model' '1' '10000000' '300'
if __name__ == "__main__":
    if(len(sys.argv)==8):
        ...
        w2v2 = W2V(utilObj=util)
        w2v2.loadVectorSpaceModel(dstFilename)
        ...
        util.logInfo('W2V', 'Vectorsize:' + str(len(vetor)))
        print(vetor2)
        print(vetor3)
        from sklearn.metrics.pairwise import cosine_similarity
